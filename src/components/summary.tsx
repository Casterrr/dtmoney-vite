...
export function Summary() {
  return (
    <div className='flex flex-row w-screen -mt-14 justify-center'>
      <div className='bg-white rounded-sm w-83 mx-4 p-8'>
      ...
      <div className='bg-greenmoney rounded-sm w-83 mx-4 p-8'>
        <header className='flex flex-row justify-between'>
