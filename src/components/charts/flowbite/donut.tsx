...
export function Donutmap() {
  ...
  if (document.getElementById("donut-chart") && typeof ApexCharts !== 'undefined') {
    ...
    function handleCheckboxChange(event: any, chart: ApexCharts) {
  ...
  return (
    <div className="max-w-sm w-full h-5/6 bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
